<div class="ModuleMemberSignUpDefault">
	<ul class="stepbar">
		<?php for ($i=0, $loop=count($step);$i<$loop;$i++) { ?>
		<li<?php echo $view == $step[$i] ? ' class="current"' : ''; ?>>
			<i class="fa fa-square-o"></i>
			<span><?php echo $Module->getLanguage('signup/step/'.$step[$i]); ?></span>
		</li>
		<?php } ?>
		<!--
	...
	<div class="row">
		<div class="col-sm-5">
			<?php if (file_exists(__IM_PATH__.'/externals/signup.php') == true) INCLUDE __IM_PATH__.'/externals/member.signup.php'; ?>
		</div>
