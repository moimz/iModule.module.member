			...
			<ul data-role="form" class="inner black social">
				...
				<li>
					...
					<div>
						...
						<a href="<?php echo $me->getOAuthLoginUrl($oauth->site->site); ?>" data-social="<?php echo $oauth->site->site; ?>"><i class="site"></i><span><?php echo str_replace('{SITE}',$me->getText('social/'.$oauth->site->site),$me->getText('social/connect')); ?></span><i class="connect"></i></a>
						<?php } else { ?>
